...
<head>
    ...
    <title>Movies Dashboard - CineSphere</title>
    <style>
        body {
...
<body>
    ...
    <div class="button-container">
        <div class="button-row">
            <a href="adminAddMovie.php" class="button button-green">Add Movie</a>
            <a href="adminDeleteMovie.php" class="button button-purple">Delete Movie</a>
            <a href="adminEditMovie.php" class="button button-yellow">Edit Movie</a>
        </div>
        <div class="button-row">
            <a href="adminMovies.php" class="button button-blue">Movies List</a>
