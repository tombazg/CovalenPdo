...
<head>
    ...
    <title>Users Dashboard - CineSphere</title>
    <style>
        body {
...
<body>
    ...
    <div class="button-container">
        <div class="button-row">
            <a href="adminAddUser.php" class="button button-green">Add User</a>
            <a href="adminDeleteUser.php" class="button button-purple">Delete User</a>
            <a href="adminEditUser.php" class="button button-yellow">Edit User</a>
        </div>
        <div class="button-row">
            <a href="adminUsers.php" class="button button-blue">User List</a>
